...
class DataLoaderComponent:
    def __init__(
        ...
        self._train_loader, self._valid_loader, self._test_loader = self._build_dataloader(loader_config)

    def _build_dataloader(self, loader_config: dict) -> tuple[DataLoader, DataLoader, DataLoader]:
